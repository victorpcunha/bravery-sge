  ...
  return (
      <div className="container mx-auto py-8 px-4">
        <div className="flex items-center justify-between mb-8">
          ...
          <Button asChild className="bg-success hover:bg-success shadow-lg shadow-emerald-500/20">
          ...
          <CardContent className="pt-6">
            <div className="relative">
              ...
              <Input 
                ...
                className="pl-10 bg-input/80 border-border focus:border-success focus:ring-success/20"
                value={searchTerm}
        ...
        {mockMatriculas.length === 0 ? (
          <Card className="border-0 shadow-lg card-glass animate-fade-in-up delay-150">
            <CardContent className="flex flex-col items-center justify-center py-16">
              <div className="w-20 h-20 bg-gradient-to-br from-success/10 to-primary/10 rounded-2xl flex items-center justify-center mb-6">
                <DoorOpen className="h-10 w-10 text-success" />
              </div>
              <h3 className="text-xl font-semibold text-foreground mb-2">Nenhuma matrícula realizada</h3>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-gradient-to-br from-success/20 to-primary/20 rounded-full flex items-center justify-center">
                        <span className="text-sm font-bold text-success">{matricula.aluno.charAt(0)}</span>
                      </div>
                      <CardTitle className="text-lg font-semibold text-foreground group-hover:text-success transition-colors">{matricula.aluno}</CardTitle>
                    </div>
                    <Badge className="bg-success-light text-success hover:bg-success-light border-0">
                      Matriculado
                    </Badge>
                  </div>
                </CardHeader>
        ...
        <div className="mt-8 p-5 bg-card/60 backdrop-blur-sm rounded-2xl border border-border/50 shadow-sm animate-fade-in-up delay-300">
          <div className="flex items-center justify-between">
            <div>
              <h4 className="font-semibold text-foreground">Total: {mockMatriculas.length} matrícula(s)</h4>
              <p className="text-sm text-muted-foreground">
                Estes dados serão enviados ao Census INEP 2026 (Registro 60 - 33 campos)
              </p>
            </div>
            <div className="w-12 h-12 bg-gradient-to-br from-success/10 to-ring/10 rounded-xl flex items-center justify-center">
